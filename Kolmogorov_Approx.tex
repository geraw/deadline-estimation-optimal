...
\begin{theorem}\label{the:complexityDual}
	The $binsearchApprox(X,m)$ algorithm runs in time $O(n^2log(n))$, using $O(n^2)$ memory where $n=|\support(X)|$.
\end{theorem}
\begin{proof}
